      ...
      keys.forEach((key) => {
        ...
        if (key.key == decodedKey) {
          ...
          if (key.rank == "Owner") {
            ...
            document.getElementById("staffArea").style.display = "block";
            document.getElementById("keyInfo").style.display = "none";
            document.getElementsById("keyMgr").style.display = "block";
            document.getElementsById("cookieBan").style.display = "block";
            document.getElementsById("localBan").style.display = "block";
          };
        };
      });
